...
console="vnmrs"
   ...
   DefaultLogFile="$gitdir/../logs/gitRcdoutlog"
...
echo "" | tee -a $log_file
echo "M a k i n g   O p e n V n m r J   R E S Y N A N T  D V D   I m a g e" | tee -a $log_file
...
do
      ...
      makeTOC ${dir}.tar $Vnmr  rht/resy.rht
done
  ...
  case x$dir in
   ...
   ;;
      ...
      * )
      ...
      makeTOC ${dir}.tar "$Subject"  rht/resy.rht
   ;;
   esac
done
...
#       makeTOC jre.tar $Vnmr rht/resy.rht
...
#
   ...
   then
     ...
     cp $gitdir/src/gif/resy.png icon/.
     cd $dest_dir_code/rht
     cp $gitdir/src/gif/installResy install
